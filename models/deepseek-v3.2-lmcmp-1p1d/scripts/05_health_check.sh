#!/bin/bash
# ============================================================
# 05_health_check.sh — 1P + 1D (DeepSeek-V3.2-NVFP4)
# ============================================================
...
if [ "${NUM_GPUS:-0}" -lt 8 ]; then
  echo "[WARN] Expected ≥8 GPUs for this layout; saw ${NUM_GPUS:-0}."
fi
...
echo ""
echo "============================================================"
echo " Health Check — DeepSeek-V3.2-NVFP4 (LMCache MP, 1P+1D)"
echo "============================================================"
