...
# Shared by prefiller + decoder (1P1D: one server, two vLLM engines).
# ============================================================
...
# L1 is host RAM for the MP server process — size to system memory, not GPU headroom.
L1_GB="${LMCACHE_L1_GB:-200}"
WORKERS="${LMCACHE_MP_MAX_WORKERS:-8}"
